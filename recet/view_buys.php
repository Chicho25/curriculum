...
<main role="main" class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="background-color:#1c7c1a;">
    ...
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Compras</h6>
      <small>Ver todas las compras hecha a proveedores</small>
    </div>
  </div>

  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="border-bottom border-gray pb-2 mb-0">Compras</h6>
