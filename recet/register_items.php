...
<main role="main" class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="background-color:#1c7c1a;">
    ...
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Registrar Material</h6>
      <small>Registro de Maeriales</small>
    </div>
  </div>
  ...
  <div class="form-row">
        <div class="form-group col-md-6">
          <label for="inputCity">Nombre del Material</label>
    ...
    <div class="form-row">
      ...
      <input type="text" class="form-control" id="inputCity">
        ...
        <div class="form-group col-md-6">
        <label for="inputState">Seleccionar Localidad del material</label>
        <select id="inputState" class="form-control">
            <option selected>Localidad 1</option>
    ...
    <div class="form-row">
      ...
      <input type="file" class="form-control" id="inputCity">
        ...
        <div class="form-group col-md-6">
        <label for="inputState">Costo por Kg</label>
        <input type="text" class="form-control" id="inputCity">
        </div>
    </div>
